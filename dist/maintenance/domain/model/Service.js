...
class Service {
    constructor(id, tipo_servicio, descripcion, num_cliente, num_bicicleta, precio_base, precio_total, costo_piezas, fecha_ingreso = new Date(), estado, mecanico_id, fecha_entrega) {
        this.id = id;
